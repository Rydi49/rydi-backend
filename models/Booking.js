...
const bookingSchema = new mongoose.Schema({
  ...
  status: { type: String, enum: ['pending_payment', 'pending', 'confirmed', 'completed', 'rejected', 'cancelled'], default: 'pending' },
...
// Indexes for performance and double-booking prevention
bookingSchema.index({ bikeId: 1, startDate: 1, endDate: 1 });
